...
import type { CashRegister, CashRegisterActionState } from "@/lib/cash/types";
...
export function CashRegisterPanel({ cashRegister }: CashRegisterPanelProps) {
  ...
  const state = closeState.message ? closeState : openState;
